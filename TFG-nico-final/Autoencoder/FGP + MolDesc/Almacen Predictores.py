...
# 7. GUARDADO Y VISUALIZACIÓN
# ================================
full_model.save("predALL_17.keras")

# Guardar historial
hist_df = pd.DataFrame(history.history)
hist_df.to_csv("predALL_17.csv", index=False)
...
plt.legend()
plt.grid(True)
plt.savefig("predALL_17.png", dpi=300, bbox_inches='tight')
plt.close()
...
# 7. GUARDADO Y VISUALIZACIÓN
# ================================
full_model.save("predALL_18.keras")

# Guardar historial
hist_df = pd.DataFrame(history.history)
hist_df.to_csv("predALL_18.csv", index=False)
...
plt.legend()
plt.grid(True)
plt.savefig("predALL_18.png", dpi=300, bbox_inches='tight')
plt.close()
...
# 7. GUARDADO Y VISUALIZACIÓN
# ================================
full_model.save("predALL_19.keras")

# Guardar historial
hist_df = pd.DataFrame(history.history)
hist_df.to_csv("predALL_19.csv", index=False)
...
plt.legend()
plt.grid(True)
plt.savefig("predALL_19.png", dpi=300, bbox_inches='tight')
plt.close()
...
# 7. GUARDADO Y VISUALIZACIÓN
# ================================
full_model.save("predALL_20.keras")

# Guardar historial
hist_df = pd.DataFrame(history.history)
hist_df.to_csv("predALL_20.csv", index=False)
...
plt.legend()
plt.grid(True)
plt.savefig("predALL_20.png", dpi=300, bbox_inches='tight')
plt.close()
...
full_model.save("ALL_Asim9.keras")

hist_df = pd.DataFrame(history.history)
hist_df.to_csv("ALL_Asim9.csv", index=False)
...
plt.legend()
plt.grid(True)
plt.savefig("ALL_Asim9.png", dpi=300, bbox_inches='tight')
plt.close()
